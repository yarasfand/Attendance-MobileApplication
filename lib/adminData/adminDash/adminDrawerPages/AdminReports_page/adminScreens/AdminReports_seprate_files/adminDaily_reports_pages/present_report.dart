...
import 'adminDaily_reports_pdf/mobile.dart';

class AdminPresentReport extends StatefulWidget {
  const AdminPresentReport({Key? key});

  @override
  State<AdminPresentReport> createState() => _AdminPresentReportState();
}

class _AdminPresentReportState extends State<AdminPresentReport> {
  ...
  Future<void> _createPdf(List<Map<String, dynamic>> data) async {
    ...
    document.dispose();
    AdminSaveAndLaunchFile(bytes, "present_reports.pdf");
  }
