...
class EmpAttendanceReport extends StatefulWidget {
  const EmpAttendanceReport({super.key});

  @override
  State<EmpAttendanceReport> createState() => _EmpAttendanceReportState();
}
...
class _EmpAttendanceReportState extends State<EmpAttendanceReport> {
  ...
  Future<void> _createPdf(List<Map<String, dynamic>> data) async {
    ...
    document.dispose();
    empSaveAndLaunchFile(bytes, "attendance_report.pdf");
  }
  ...
  Future<void> _createExcel(List<Map<String, dynamic>> data) async {
    ...
    final String fileName = '$path/attendance_report.xlsx';
