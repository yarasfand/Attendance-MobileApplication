...
class AdminAbsentReports extends StatefulWidget {
  const AdminAbsentReports({super.key});

  @override
  State<AdminAbsentReports> createState() => _AdminAbsentReportsState();
}

class _AdminAbsentReportsState extends State<AdminAbsentReports> {
  ...
  Future<void> _createPdf(List<Map<String, dynamic>> data) async {
    ...
    document.dispose();
    AdminSaveAndLaunchFile(bytes, "absent_reports.pdf");
  }
