...
class AdminAttendanceReport extends StatefulWidget {
  ...
  @override
  State<AdminAttendanceReport> createState() => _AdminAttendanceReportState();
}

class _AdminAttendanceReportState extends State<AdminAttendanceReport> {
  ...
  Future<void> _createPdf(List<Map<String, dynamic>> data) async {
    ...
    document.dispose();
    AdminSaveAndLaunchFile(bytes, "attendance_report.pdf");
  }
